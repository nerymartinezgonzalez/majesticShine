    ...
    <div>
     ...
     <center>
      ...
      <DropDownMenu
        ...
        autoWidth={false}
      >
        <MenuItem value={1} primaryText="110-130lbs" />
        <MenuItem value={2} primaryText="130-160lbs"/>
        <MenuItem value={3} primaryText="160-190lbs"/>
        <MenuItem value={4} primaryText="190-220LBS"/>
      </DropDownMenu>
          {this.state.meal === {} ? null : (
            <div>
              <p>{this.state.meal.diet}</p><br/>
            </div>
          )}
      </center>
          </MuiThemeProvider>
